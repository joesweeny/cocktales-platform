...
class CocktailIngredientOrchestratorTest extends TestCase
{
    use RunsMigrations,
        UsesContainer;
    ...
    public function setUp()
    {
        ...
        $this->orchestrator = $this->container->get(CocktailIngredientOrchestrator::class);
        $this->connection = $this->container->get(Connection::class);
    }

    public function test_insert_cocktail_ingredient_increases_table_count()
    {
        $this->orchestrator->insertCocktailIngredient(new CocktailIngredient(
    ...
    public function test_get_cocktail_ingredients_returns_a_collection_of_cocktail_ingredients_linked_to_associated_cocktail_id()
    {
        ...
        $fetched = $this->orchestrator->getCocktailIngredients(new Uuid('fe8f3ec8-1711-412c-8324-c1e1e5f19454'));
