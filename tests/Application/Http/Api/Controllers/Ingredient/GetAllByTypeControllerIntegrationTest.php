...
class GetAllByTypeControllerIntegrationTest extends TestCase
{
    ...
    public function test_success_response_is_received_with_ingredients_details()
    {
        ...
        $this->assertEquals('6a56edad-530f-4b75-9389-050e2aa3c34a', $jsend->data->allIngredientsByType->ALCOPOP[0]->id);
        ...
        $this->assertEquals('672f0f74-190a-4e73-ba82-84f6aed308ad', $jsend->data->allIngredientsByType->GIN[0]->id);
